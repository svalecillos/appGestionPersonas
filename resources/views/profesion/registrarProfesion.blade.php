...
@section('content')
	<div id="breadcrumbs-wrapper">
        <div class="row">
            <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title">Registrar Profesion</h5>
    ...
    <div class="row">
    	<div class="col s12 m12 l8">
    		 <form  id="formularioAdministrativo" method="post" action="{{ url('profesion/crear') }}">
    		 	{{ csrf_field() }}
    		 		...
    		 		<div class="row">
    		 			<div class="row">
                            ...
                            <div class="input-field col s6">
                                ...
                                <label for="icon_prefix">Nombre de la profesion</label>
                            </div>
                            <div class="input-field col s6">
